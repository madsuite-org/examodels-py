...
def _configure_runtime():
    ...
    # Let Julia install its signal handlers. Without them the runtime's own
    # signals -- the GC's safepoint faults among them -- arrive at CPython
    # unhandled and kill the process mid-suite: SIGSEGV on Linux, SIGTRAP or
    # SIGABRT on macOS, at whichever call happens to be running. juliacall
